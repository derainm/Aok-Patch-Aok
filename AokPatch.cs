 ...
 */
                ...
                #endregion windowed 2.0 old

                #region windowed  2.0 optimised
                //.pdata .patch
                //Injection(0x100, "504500004C010900");
                //Injection(0x150, "00F03E00");
                //Injection(0x310, "2E7064617461000000100000002038000010000000102700000000000000000000000000E00000E02E7061746368000000C006000030380000C0060000202700000000000000000000000000E00000E0");

                //invoke the windowed.dll
                Injection(0x600305, "E976B60100");
                Injection(0x61B980, "A3902777006898B96100FF1510C16100E97549FEFF");
                Injection(0x4f00de, "909090909090");

                //fix mouse cursor 
                Injection(0x41f80A, "6690");
                Injection(0x48AD1D, "6690");
                //005D95F8  |. 75 2D          JNZ SHORT empires2.005D9627
                Injection(0x5D95F8, "6690");
                //005DF91B  |. 75 17          JNZ SHORT empires2.005DF934
                Injection(0x5DF91B, "6690");

                //7D0CE1 string windowed path
                //Injection(0x2BFce1, "616765325F78315C776E646D6F64652E646C6C");
                Injection(0x61B998, "616765325F78315C776E646D6F64652E646C6C");
                #endregion windowed 2.0 optimised

            }
            if (radioButton_20b.Checked)
            {
                #region windowed  2.0b optimised
                //invoke the windowed.dll
                //Injection(0x600305, "E976B60100");
                Injection(0x61A989, "689AA96100FF1510B16100E9B13AFEFF00");
                Injection(0x61A99A, "616765325F78315C776E646D6F64652E646C6C");
                Injection(0x4F064E, "909090909090");

                //fix mouse cursor
                Injection(0x41F86A, "6690");
                Injection(0x48B06D, "6690");

                #endregion windowed  2.0b optimised

            }
            if (radioButton_20a.Checked)
            {
                #region windowed  2.0a optimised
                //invoke the windowed.dll
                //005FE445  |. A3 90157700    MOV DWORD PTR DS:[771590],EAX
                Injection(0x5FE445, "E93AC50100");
                Injection(0x61A984, "A390157700689AA96100FF1510B16100E9B13AFEFF00");
                Injection(0x61A99A, "616765325F78315C776E646D6F64652E646C6C");
                Injection(0x4F064E, "909090909090");
                ...
                Injection(0x41F86A, "6690");
                Injection(0x48B06D, "6690");
                //005DA9B8  |. 75 2D          JNZ SHORT empires2.005DA9E7
                Injection(0x5DA9B8, "6690");
                //005E0EDB  |. 75 17          JNZ SHORT empires2.005E0EF4
                Injection(0x5E0EDB, "6690");
                #endregion windowed  2.0a optimised
            }
            File.WriteAllBytes(this.gameExe, exe);
            MessageBox.Show("Done.");
        }
        ...
        private void buttonAddRMS_Click(object sender, EventArgs e)
        {
            ...
            //007E1000
            Injection(0x2CFFF2, "C705002A78000400000090909090E83B19CDFFA3F0297800890DE02978008915D0297800C705102A780018000000C705202A78007B2A00008B15002A7800A1102A78008B0D202A780083C00149A3102A7800890D202A780050518B0E4A8915002A7800E8E618CDFF833D002A78000075C7E91558D2FF");
        ...
        private void buttonFixLag_Click(object sender, EventArgs e)
        {
            ...
            // Fix multiplayer network bugs
            //Injection(0x1d476b, "38");
            //Injection(0x1ccc1d, "24FA");
            //Injection(0x1ccc34, "D007");
            //Injection(0x1a69b0, "8B566C");
            //Injection(0x1a69f5, "3B466C");
            //Injection(0x1a6e8e, "EB");
            //Injection(0x1a6edf, "E98A01000090");
            //Injection(0x1a6dcb, "6690");
            //Injection(0x1ca7a3, "7C");
            //Injection(0x1a6ab8, "EB4A66666690");
            //Injection(0x1a67eb, "09");
            //Injection(0x1a6800, "535633DB578D73018B0DA012790056E8CC5004008BF885FF7E4D8B0D0012790056E82A2E030083F802743BA1A01279008B80240400008B484C8B0CB9E85FD6FAFF85C075228B15A01279008A84329D10000084C075118B0D0012790056E89EE2020085C07501434683FE097C9B5F8BC35E5BC390");
            //Injection(0x1d7010, "31C0C3666690");
            //Injection(0x1d7030, "C2040090");
            //Injection(0x1d73d0, "C36690");
            //Injection(0x1d7350, "C20800666690");
            //Injection(0x1d7290, "C2080090");
            //Injection(0x1d1a1f, "");
            //Injection(0x1d6f20, "535556578BF931ED31DB8BB7E01D000001DE8B0639E8740950E880C8030083C40483C318892E81FBE8FF1700896E04896E08896E0C896E10896E1476CD31DB8BB7DC1D000001DE8B0639E8740950E84BC8030083C40483C310892E81FBF0FF0100896E04896E08896E0C76D35F5E5D5BC390");
            //Injection(0x1d6fb0, "535556578B44241431ED48C1E0108D04408B99E01D000031FF01C38D343B8B0639E8740950E8E4C7030083C404892E896E04896E08896E0C896E10896E1483C71881FF0000030072D25F5E5D5BC20400666690");
            //Injection(0x1d7080, "");
            
            //Injection(0x1d7180, "");
            //Injection(0x1d7880, "");
            //Injection(0x1d20f6, "EB5566666690");
            //Injection(0x1d2165, "10");
            //Injection(0x1d1fd0, "8BC131C9890889480489480889480CC36690");
            //Injection(0x1d1ff0, "568BF18B0185C0740B50E8BF17040031C083C40489460889460489460C89065EC3");
            //Injection(0x1d6ce0, "");
            //Injection(0x1d74c0, "");
            //Injection(0x1d2063, "897E145F5EC3");
            //Injection(0x1d4359, "766C8B8D341300008B9424C40300008B8424C003000041898D341300008B8C24B803000056528B5308505153528BCDE8F32C00005F5E5DB8010000005B81C4A4030000C214000F1F840000000000660F1F8400000000000F1F8400000000008B8C24C803000085C90F84C9290000");
            //Injection(0x1d6d90, "8D50018D46FF8B8DE01D0000C1E0108D044001C18BC225FF1F0000C1E0038D044001C83950040F850BD6FFFF8D56FFC7049580527A0000000000E9F8D5FFFF6690");
            //Injection(0x1d7e74, "01");
            //Injection(0x1d7f5b, "00");
            //Injection(0x1da8d8, "C0");
            //Injection(0x1da8e2, "C0");
            //Injection(0x1d077e, "C0");
            //Injection(0x1d3bb4, "EB1190");
            //Injection(0x1d42a5, "7D383C5874383C4375138A531C20D27529660F1F440000660F1F440000");
            //Injection(0x1d433e, "5F5E5DB8010000005B81C4A4030000C21400");
            //Injection(0x1d43e9, "8B85AC12000085C075398B8424C40300008B8C24C00300008B15A80F790050A1A40F790051668B4B01528A13508B4304518B8C24CC030000525056518BCDE8B40000005F5E5DB8010000005B81C4A4030000C2140066666690");
            //Injection(0x1d7f67, "E947FFFFFF");
            //Injection(0x1d7f2b, "EB86666690");
            ...
            //0045C055  |. 48             |DEC EAX
            Injection(0x45C055, "3B466C");
            //0045C4EE  |. 74 32          JE SHORT empires2.0045C522
            Injection(0x45C4EE, "EB32");
            //0045C53F  |> 8DA9 E8080000  LEA EBP,DWORD PTR DS:[ECX+8E8]   -> jmp 0045C6CE  |> 5F             POP EDI
            Injection(0x45C53F, "E95401000090");
            //0045C42B     66:90          NOP
            Injection(0x45C42B, "6690");
            //0043A1B3  |.^7E E9          \JLE SHORT empires2.0043A19E
            Injection(0x43A1B3, "7CE9");
            //0045C118     EB 4A          /JMP SHORT empires2.0045C164
            Injection(0x45C118, "EB4A66666690");
            //0045BE49     83FE 09        CMP ESI,9
            Injection(0x45BE49, "83FE09");
            //0045BE60  /$ 53             PUSH EBX
            Injection(0x45BE60, "535633DB578D73018B0DC445660056E89C63FCFF8BF885FF7E4D8B0D2045660056E8FA16FDFF83F802743BA1C44566008B801C0400008B484C8B0CB9E8CF3A030085C075228B15C44566008A84329510000084C075118B0D2045660056E81ECCFCFF85C07501434683FE097C9B5F8BC35E5BC3");
            //0042AF40  /$ 8B89 D81D0000  MOV ECX,DWORD PTR DS:[ECX+1DD8]
            Injection(0x42AF40, "31C0C3666690");
            //0042AF60  /$ 8B4424 04      MOV EAX,DWORD PTR SS:[ESP+4]
            Injection(0x42AF60, "C2040090");
            //0042B300  /$ 83EC 08        SUB ESP,8
            Injection(0x42B300, "C36690");
            //0042B280     C2 0800        RETN 8
            Injection(0x42B280, "C20800666690");
            //00425ACC  |> 68 D46D0000    PUSH 6DD4
            Injection(0x425ACC, "");
            //0042AE50  /$ 51             PUSH ECX
            Injection(0x42AE50, "90535556578BF933ED33DB8BB7DC1D000003F38B063BC5740950E841E21C0083C40483C318892E81FBE8FF1700896E04896E08896E0C896E10896E1476CD33DB8BB7D81D000003F38B063BC5740950E80CE21C0083C40483C310892E81FBF0FF0100896E04896E08896E0C76D35F5E5D5BC3909090");
            //0042AEE0  /$ 53             PUSH EBX
            Injection(0x42AEE0, "535556578B44241433ED48C1E0108D04408B9BDC1D000033FF03D88D343B8B063BC5740950E8A6E11C0083C404892E896E04896E08896E0C896E10896E1483C71881FF0000030072D25F5E5D5BC2040066669090");
